...
SECRET_KEY = '**66o2u@v!bim=%or^&zaxp-x3ll&j=^mefr&*9l8q&8trxzvj'
...
INSTALLED_APPS = [
    ...
    'bootstrap4',  # pip install ... https://django-bootstrap.readthedocs.io/en/latest/installation.html
    'bootstrapform',
    'widget_tweaks',
    'albion',
    'vitiaz',
